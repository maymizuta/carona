<div class="historicos index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $historico['Historico']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $historico['Historico']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
