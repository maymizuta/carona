<div class="agendamentos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('diaDaSemana'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($agendamento['Agendamento']['diaDaSemana']); ?>&nbsp;</td>
		<td><?php echo h($agendamento['Agendamento']['horarioDePartida']); ?>&nbsp;</td>
		<td><?php echo h($agendamento['Agendamento']['horarioDeSaida']); ?>&nbsp;</td>
		<td class="actions">
